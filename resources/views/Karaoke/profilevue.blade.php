...
.custom-modal-body {
  background-color: #5165ff; /* Remplacez cette couleur par celle de votre choix */
  border-color: #5165ff; /* Vous pouvez ajuster la couleur de la bordure si nécessaire */
