                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            ...
                                            <form method="post" action="{{ route('delete.user', ['id' => $user->id, 'redirect' => 'KaraokeUsers']) }}" id="delete-form-{{ $user->id }}">
                                                @csrf
                                                @method('POST')
                                                <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete({{ $user->id }})">Supprimer</button>
                                            </form>
                                        </td>
                                    </tr>
                                    @endforeach
