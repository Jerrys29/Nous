        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card card-body">
                    <form class="form handleSubmit" action="<?php echo e(route('publicites.create')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('templates.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Documents\Abitech2024\Nous\resources\views/Admin/publicite/create.blade.php ENDPATH**/ ?>