...
.eye-toggle.active .toggle-icon {
        ...
        <div class="container">
            <div class="booking-content">
                <div class="booking-image">
                    <img class="booking-img" src="<?php echo e(asset('assets/slides/5.jpg')); ?>" alt="Image de réservation" style="height: 100%;">
                </div>
                <div class="booking-form">
                    <form id="booking-form" method="post" action="<?php echo e(route('login')); ?>">
                        <?php echo csrf_field(); ?>
                        <a href="<?php echo e(('/')); ?>">
                            <div class="img-logo">
    ...
    <span toggle="#password" class="eye-toggle">
        <i class="fa fa-eye toggle-icon" aria-hidden="true"></i>
                            ...
                            <?php if(session('error') || !auth()->check()): ?>
                            <p>Vous n'avez pas de compte ? <a href="<?php echo e(route('inscription.store')); ?>" style="color: white;">Inscrivez-vous ici</a>.</p>
                            <?php endif; ?>
                        </div>
                    </form>
                </div>
...
</html><?php /**PATH C:\Users\HP\Documents\Abitech2024\Nous\resources\views/Nous/login.blade.php ENDPATH**/ ?>