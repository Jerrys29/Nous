	...
	<section class="ftco-section">
		<div class="container">
			...
			<?php endif; ?>
		      	...
		      	<form method="POST"  action="<?php echo e(route('logins')); ?>" class="signin-form">
				  <?php echo csrf_field(); ?>
	         ...
	         <a href="<?php echo e(('/inscription')); ?>"> <p class="w-100 text-center">&mdash; ou S'inscrire &mdash;</p></a>
...
<?php /**PATH C:\Users\HP\Documents\Abitech2024\Nous\resources\views/Karaoke/connection.blade.php ENDPATH**/ ?>