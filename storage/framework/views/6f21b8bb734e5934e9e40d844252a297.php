                ...
                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class="align-middle text-center text-sm">
                            <?php if($user->active && $user->activated_at): ?>
                                <span class="badge badge-sm bg-gradient-success">Activé</span>
                            <?php elseif(!$user->active && $user->activated_at): ?>
                        ...
                        <td class="align-middle">
                            <?php if(!$user->active): ?>
                                <form method="post" action="<?php echo e(route('unblock.user', ['id' => $user->id, 'redirect' => 'LokKaraokeUsers'])); ?>">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('templates.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Documents\Abitech2024\Nous\resources\views/Admin/LokKaraokeUsers.blade.php ENDPATH**/ ?>