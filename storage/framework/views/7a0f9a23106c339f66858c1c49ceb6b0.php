                ...
                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class="align-middle text-center text-sm">
                            <span class="badge badge-sm <?php echo e($user->active ? 'bg-gradient-success' : 'bg-gradient-secondary'); ?>">
                                <?php echo e($user->active ? 'Activé' : 'Désactivé'); ?>

                            </span>
                        </td>
                        <td class="align-middle">
                            <form method="post" action="<?php echo e(route('block.user', ['id' => $user->id, 'redirect' => 'KaraokeUsers'])); ?>">
                                <?php echo csrf_field(); ?>
                            ...
                            <form method="post" action="<?php echo e(route('unblock.user', ['id' => $user->id, 'redirect' => 'KaraokeUsers'])); ?>">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('POST'); ?>
                                <?php if(!$user->active): ?>
...
<?php echo $__env->make('templates.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Documents\Abitech2024\Nous\resources\views/Admin/KaraokeUsers.blade.php ENDPATH**/ ?>