        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Compte utilisateurs Nous Bloqués</h6>
            </div>
            ...
            <tbody>
                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <form method="post" action="<?php echo e(route('unblock.user', ['id' => $user->id, 'redirect' => 'LokNousUsers'])); ?>">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('templates.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Documents\Abitech2024\Nous\resources\views/Admin/LokNousUsers.blade.php ENDPATH**/ ?>