...
<body>
    ...
    <?php endif; ?>
    <?php echo $__env->make('components.headerKa', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <main id="main">
    <?php if(!$user->photo1): ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="user-images">
                            <img src="<?php echo e(asset('storage/' . $user->photo1)); ?>" alt=" Photo de profil ">
                            <img src="<?php echo e(asset('storage/' . $user->photo2)); ?>" alt="Photo 2">
                            <img src="<?php echo e(asset('storage/' . $user->photo3)); ?>" alt=" Photo 3">
                            <img src="<?php echo e(asset('storage/' . $user->photo4)); ?>" alt=" Photo 4">
                            <img src="<?php echo e(asset('storage/' . $user->photo5)); ?>" alt=" Photo 5">
                            <img src="<?php echo e(asset('storage/' . $user->photo6)); ?>" alt=" Photo 6">
                    ...
                    <div class="col-lg-6 ">
                        ...
                        <div class="mb-3">
                            ...
                            <span id="userName"><?php echo e($user->pseudo); ?></span>
                            ...
                            <div class="modal fade" id="editPseudo" tabindex="-1" aria-labelledby="editPseudoLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form method="post" action="<?php echo e(route('update-pseudo', ['id' => $user->id])); ?>">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PUT'); ?>
                                            <div class="modal-body">
                                                <label for="editField">Nouvelle valeur:</label>
                                                <input type="text" name="pseudo" value="<?php echo e($user->pseudo); ?>" class="form-control" required required style="font-size: 20px;">
                        ...
                        <div class="mb-3">
                            ...
                            <span id="userPhone"><?php echo e($user->numero); ?></span>
                            ...
                            <div class="modal fade" id="editNumero" tabindex="-1" aria-labelledby="editNumeroLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form method="post" action="<?php echo e(route('update-numero', ['id' => $user->id])); ?>">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PUT'); ?>
                                            <div class="modal-body">
                                                <label for="editField">Nouvelle valeur:</label>
                        ...
                        <div class="mb-3">
                            ...
                            <span id="userName"><?php echo e($user->name); ?></span>
                            ...
                            <div class="modal fade" id="editName" tabindex="-1" aria-labelledby="editNameLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form method="post" action="<?php echo e(route('update-name', ['id' => $user->id])); ?>">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PUT'); ?>
                                            <div class="modal-body">
                                                <label for="editField">Nouvelle valeur:</label>
                                                <input type="text" name="name" value="<?php echo e($user->name); ?>" class="form-control" required style="font-size: 20px;">
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Quitter</button>
                                                <button type="submit" class="btn btn-primary" onclick="saveEdit()">Enregistrer</button>
    ...
    <div class="modal fade" id="imageModal" tabindex="-1" aria-labelledby="imageModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form method="POST" action="<?php echo e(route('store-images1')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="user_id" value="<?php echo e($user->id); ?>">
                    <div class="modal-body">

                        <div class="image-container">
                            <img src="<?php echo e(asset('storage/' . $user->photo1)); ?>" alt="Photo de profil" class="image-cropper" data-image-index="1">
                ...
                <form method="POST" action="<?php echo e(route('store-images2')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="user_id" value="<?php echo e($user->id); ?>">
                    <div class="modal-body">

                        <div class="image-container">
                            <img src="<?php echo e(asset('storage/' . $user->photo2)); ?>" alt="photo 2" class="image-cropper" data-image-index="2">
                ...
                <form method="POST" action="<?php echo e(route('store-images3')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="user_id" value="<?php echo e($user->id); ?>">
                    <div class="modal-body">

                        <div class="image-container">
                            <img src="<?php echo e(asset('storage/' . $user->photo3)); ?>" alt="photo 3" class="image-cropper" data-image-index="3">
                ...
                <form method="POST" action="<?php echo e(route('store-images4')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="user_id" value="<?php echo e($user->id); ?>">
                    <div class="modal-body">

                        <div class="image-container">
                            <img src="<?php echo e(asset('storage/' . $user->photo4)); ?>" alt="photo 4" class="image-cropper" data-image-index="4">
                ...
                <form method="POST" action="<?php echo e(route('store-images5')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="user_id" value="<?php echo e($user->id); ?>">
                    <div class="modal-body">

                        <div class="image-container">
                            <img src="<?php echo e(asset('storage/' . $user->photo5)); ?>" alt="photo 5" class="image-cropper" data-image-index="5">
                ...
                <form method="POST" action="<?php echo e(route('store-images6')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="user_id" value="<?php echo e($user->id); ?>">
                    <div class="modal-body">

                        <div class="image-container">
                            <img src="<?php echo e(asset('storage/' . $user->photo6)); ?>" alt="photo 6" class="image-cropper" data-image-index="6">
    ...
    <script>
        ...
        function uploadNewImages() {
            ...
            $.ajax({
                url: '<?php echo e(route("store-images1")); ?>',
                method: 'POST',
                headers: {
...
</html><?php /**PATH C:\Users\HP\Documents\Abitech2024\Nous\resources\views/Karaoke/profilperso.blade.php ENDPATH**/ ?>