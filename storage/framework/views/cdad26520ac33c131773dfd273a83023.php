    ...
    <main id="main">
        ...
        <section id="user-profile" class="user-profile">
            <div class="container">
                ...
                <div class="user-images">
                    <div class="row">
                        ...
                        <div class="col-lg-3 user-image-col mb-3">
                            <img class="img-fluid" src="<?php echo e(asset('storage/' . $user->photo1)); ?>" alt="Photo 1">
                        </div>
                        <?php endif; ?>

                        <?php if($user->photo2): ?>
                        <div class="col-lg-3 user-image-col mb-3">
                            <img class="img-fluid" src="<?php echo e(asset('storage/' . $user->photo2)); ?>" alt="Photo 2">
                        </div>
                        <?php endif; ?>

                        <?php if($user->photo3): ?>
                        <div class="col-lg-3 user-image-col mb-3">
                            <img class="img-fluid" src="<?php echo e(asset('storage/' . $user->photo3)); ?>" alt="Photo 3">
                        </div>
                        <?php endif; ?>

                        <?php if($user->photo4): ?>
                        <div class="col-lg-3 user-image-col mb-3">
                            <img class="img-fluid" src="<?php echo e(asset('storage/' . $user->photo4)); ?>" alt="Photo 4">
                        </div>
                        <?php endif; ?>

                        <?php if(!$user->photo1 && !$user->photo2 && !$user->photo3 && !$user->photo4 ): ?>
                        <div class="col-lg-12 ">
                ...
                <form action="<?php echo e(route('profile.photos.update')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" style="font-size: 16px;" id="numero" name="numero" value="<?php echo e($user->numero); ?>">
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" style="font-size: 16px;" id="email" name="email" value="<?php echo e($user->email); ?>">
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" style="font-size: 16px;"  id="name" name="name" value="<?php echo e($user->name); ?>">
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" style="font-size: 16px;"  id="pseudo" name="pseudo" value="<?php echo e($user->pseudo); ?>">
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" style="font-size: 16px;" id="age" name="age" value="<?php echo e($user->age); ?>">
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-select" id="genre" name="genre">
                                        <option value="homme" <?php echo e($user->genre == 'homme' ? 'selected' : ''); ?>>Homme</option>
                                        <option value="femme" <?php echo e($user->genre == 'femme' ? 'selected' : ''); ?>>Femme</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-select" id="looking_for" name="looking_for">
                                        <option value="homme" <?php echo e($user->looking_for == 'homme' ? 'selected' : ''); ?>>Homme</option>
                                        <option value="femme" <?php echo e($user->looking_for == 'femme' ? 'selected' : ''); ?>>Femme</option>
                                        <option value="lesdeux" <?php echo e($user->looking_for == 'lesdeux' ? 'selected' : ''); ?>>Homme et Femme</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" style="font-size: 16px;" id="town" name="town" value="<?php echo e($user->town); ?>">
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" style="font-size: 16px;"  id="origin_country" name="origin_country" value="<?php echo e($user->origin_country); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" style="font-size: 16px;"  id="birthplace" name="birthplace" value="<?php echo e($user->birthplace); ?>">
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" style="font-size: 16px;"  id="mariatal_status" name="mariatal_status" value="<?php echo e($user->mariatal_status); ?>">
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" style="font-size: 16px;"  id="hair_color" name="hair_color" value="<?php echo e($user->hair_color); ?>">
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" style="font-size: 16px;"  id="eyes_color" name="eyes_color" value="<?php echo e($user->eyes_color); ?>">
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-sm-8">
                                    <textarea class="form-control" style="font-size: 16px;"  id="about" name="about" rows="3"><?php echo e($user->about); ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" style="font-size: 16px;"  id="interests" name="interests" value="<?php echo e($user->interests); ?>">
                                </div>
                            </div>
                        </div>
...
</html><?php /**PATH C:\Users\HP\Documents\Abitech2024\Nous\resources\views/Nous/edit.blade.php ENDPATH**/ ?>