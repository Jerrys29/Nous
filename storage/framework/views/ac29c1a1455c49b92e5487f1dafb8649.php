  ...
  <section id="portfolio" class="portfolio">
    <div class="container">
      ...
      <div class="section-title">
        ...
        <button class="btn btn-danger" data-toggle="modal" data-target="#staticBackdrop">Discuter avec <?php echo e($user->name); ?></button>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="text-white mt-4">
                      ...
                      <kkiapay-widget amount="981" key="de9c4e671f1c676a8613e0a567252e182c8fc52c" callback="<?php echo e(url('/mettre-a-jour-paiement')); ?>" theme="red" />
                      <div class="mt-4 mb-5">
        ...
        <?php else: ?>
        <?php if(auth()->user()): ?>
        <a href="https://wa.me/<?php echo e($user->numero); ?>" target="_blank"><button class="btn btn-danger">Discuter avec <?php echo e($user->name); ?></button></a>
                          <?php else: ?>
                          <a href="<?php echo e(route('login')); ?>"><button class="btn btn-danger">Discuter avec <?php echo e($user->name); ?></button></a>
                          <?php endif; ?>
        <?php endif; ?>
      </div>
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="mb-3 row align-items-center">
              ...
              <div class="col-sm-8">
                <p class="form-control-static"><?php echo e($user->birthplace); ?></p>
              </div>
            </div>
            <div class="mb-3 row align-items-center">
              <label for="town" class="col-sm-4 col-form-label fw-bold">Ville:</label>
            ...
            <div class="mb-3 row align-items-center">
              ...
              <div class="col-sm-8">
                <p class="form-control-static"><?php echo e($user->mariatal_status); ?></p>
              </div>
            </div>
            <div class="mb-3 row align-items-center">
              <label for="hair_color" class="col-sm-4 col-form-label fw-bold">Couleur des cheveux:</label>
              <div class="col-sm-8">
                <p class="form-control-static"><?php echo e($user->hair_color); ?></p>
              </div>
            </div>
            <div class="mb-3 row align-items-center">
              <label for="eyes_color" class="col-sm-4 col-form-label fw-bold">Couleur des yeux:</label>
              <div class="col-sm-8">
                <p class="form-control-static"><?php echo e($user->eyes_color); ?></p>
              </div>
            </div>
            ...
            <div class="mb-3 row align-items-center">
              ...
              <div class="col-sm-8">
                <p class="form-control-static"><?php echo e($user->about); ?></p>
              </div>
            </div>
            ...
            <div class="mb-3 row align-items-center">
              ...
              <div class="col-sm-8">
                <p class="form-control-static"><?php echo e($user->interests); ?></p>
              </div>
            </div>
          </div>
        </div>
...
<?php echo $__env->make('templates.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Documents\Abitech2024\Nous\resources\views/Nous/detail.blade.php ENDPATH**/ ?>