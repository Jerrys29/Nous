          ...
          <div class="col-lg-8">
            <div class="row">
              ...
              <div class="col-lg-4 mb-3">
                <a href="detailprofil.html" style="text-decoration: none;color: inherit;cursor: auto;">
                  <div class="card">
                    <img src="assets\img\tabs-3.jpg" class="card-img-top" alt="Profile Image 1">
                    <div class="card-body">
                      <h4 class="card-title">Cathérine</h4>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Trouver un partenaire</a></li>
            </ul>
          </div>
          ...
          <div class="col-lg-5 col-md-6 footer-newsletter">
            ...
            <div>
              <a href="#about" class="btn-get-started scrollto">ESPACE KARAOKE</a>
            </div>
          </div>
...
</html><?php /**PATH C:\Users\HP\Documents\Abitech2024\Nous\resources\views/Karaoke/profils.blade.php ENDPATH**/ ?>