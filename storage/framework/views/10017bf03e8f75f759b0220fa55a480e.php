...
<body>
 ...
 <header id="header" class="fixed-top d-flex align-items-center">
  <div class="container d-flex align-items-center">
    ...
    <a href="#about" class="get-started-btn scrollto">Inscription</a>
  </div>
</header><!-- End Header -->
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      <div class="row">
        <div class="col-xl-6">
          ...
          <a href="#about" class="btn-get-started scrollto">Trouvez votre partenaire</a>
        </div>
      </div>
    </div>
    ...
    <section id="testimonials" class="testimonials">
      <div class="container" data-aos="fade-up">
        ...
        <div class="testimonials-slider swiper" data-aos="fade-up" data-aos-delay="100">
          ...
          <center>
             <div>
            <a href="persospace.html" class="btn-get-started scrollto">Trouvez votre partenaire</a>
        </div>
          </center>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-5 col-md-6 footer-newsletter">
            ...
            <div>
              <a href="Karaoke/persospace.html" class="btn-get-started scrollto">ESPACE KARAOKE</a>
          </div>
          </div>
...
</html><?php /**PATH C:\Users\HP\Documents\nous\resources\views/Nous/index.blade.php ENDPATH**/ ?>