      ...
      <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="150">
        <div class="col-6">
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <img src="<?php echo e(asset('storage/' . $user->photo1)); ?>" class="img-fluid" alt="">
            <div class="portfolio-info">
              <a href="<?php echo e(asset('storage/' . $user->photo1)); ?>" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title=""><i class="bx bx-plus"></i></a>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <img src="<?php echo e(asset('storage/' . $user->photo2)); ?>" class="img-fluid" alt="">
            <div class="portfolio-info">
              <a href="<?php echo e(asset('storage/' . $user->photo2)); ?>" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title=""><i class="bx bx-plus"></i></a>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <img src="<?php echo e(asset('storage/' . $user->photo3)); ?>" class="img-fluid" alt="">
            <div class="portfolio-info">
              <a href="<?php echo e(asset('storage/' . $user->photo3)); ?>" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title=""><i class="bx bx-plus"></i></a>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <img src="<?php echo e(asset('storage/' . $user->photo4)); ?>" class="img-fluid" alt="">
            <div class="portfolio-info">
              <a href="<?php echo e(asset('storage/' . $user->photo4)); ?>" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title=""><i class="bx bx-plus"></i></a>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <img src="<?php echo e(asset('storage/' . $user->photo5)); ?>" class="img-fluid" alt="">
            <div class="portfolio-info">
              <a href="<?php echo e(asset('storage/' . $user->photo5)); ?>" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title=""><i class="bx bx-plus"></i></a>
