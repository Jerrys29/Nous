  ...
  <div class="row">
    <div class="col-12" style="margin-top: -4rem; margin-bottom:4rem;" >
      <div class="scrolling-flags-container" onmouseover="stopAnimation()" onmouseout="startAnimation()" style="margin-top: 4rem; margin-bottom: -2rem;">
        <?php for($i = 1; $i <= 56; $i++): ?>
        <img src="<?php echo e(asset('assets/img/drap/' . $i . '.png')); ?>" alt="Drapeau <?php echo e($i); ?>" class="flag-image">
        <?php endfor; ?>
      </div>
    </div>
   </div>
  ...
  <div class="container" data-aos="zoom-out" data-aos-delay="100">
    <div class="row">
      <div class="col-xl-6">
        ...
        <a href="<?php echo e(('/profils')); ?>" class="btn-get-started scrollto">Trouvez votre partenaire</a>
      </div>
    </div>
  </div>
                        ...
                        <div class="col-12 mb-3 ">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <?php $__currentLoopData = $publicites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $publicite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#advertisementDetailModal<?php echo e($index); ?>">Détail</button>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        var publicites = <?php echo json_encode($publicites, 15, 512) ?>;
        var index = 0;
        var modal = document.getElementById('advertisementModal');

        function afficherModal() {
            modal.style.display = 'block';
            document.getElementById('advertisementLogo').setAttribute('src', "<?php echo e(asset('logos/')); ?>/" + publicites[index].logo);
...
<?php $__currentLoopData = $publicites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $publicite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="modal fade" id="advertisementDetailModal<?php echo e($index); ?>" tabindex="-1" role="dialog" aria-labelledby="advertisementDetailModal<?php echo e($index); ?>Label" aria-hidden="true">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary text-white">
        <h5 class="modal-title" id="advertisementDetailModal<?php echo e($index); ?>Label"><?php echo e($publicite->name); ?></h5>
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-4">
            <img class="d-block w-100 mb-3" src="<?php echo e(asset('logos/' . $publicite->logo)); ?>" alt="<?php echo e($publicite->name); ?>">
          </div>
          <div class="col-md-8">
            <h5><strong>Offre :</strong></h5>
            <p><?php echo e($publicite->offre); ?></p>
            <h5><strong>Détails :</strong></h5>
            <p><?php echo $publicite->detail; ?></p>
          </div>
        </div>
      </div>
    </div>
...
<?php echo $__env->make('templates.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Documents\Abitech2024\Nous\resources\views/Nous/index.blade.php ENDPATH**/ ?>